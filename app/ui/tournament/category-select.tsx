...
const CategoryTournamentSelect = ({
  ...
  return (
    <div className="flex justify-center min-w-[22rem]">
      <select
        defaultValue={catSelected}
        id="categoryId"
        name="categoryId"
        className="block w-fit p-2 rounded-md border-0 bg-white/5 py-1.5 text-white ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:leading-6 [&_*]:text-black"
